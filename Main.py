...
def showMenu ():
    ...
    while True:
        ...
        screen.blit(pygame.transform.scale(
            pygame.image.load("C:/Users/Bobby/Downloads/icon.ico"), (200, 200)), (155, 50))
...
if __name__ == "__main__":
    # load json data
    c = json.load(open("../2048 thinter/.venv/Lib/constants.json", "r"))
    ...
    screen = pygame.display.set_mode(
        (c["size"], c["size"]))
    pygame.display.set_caption("2048 By Bobby")

    # display game icon in window
    icon = pygame.transform.scale(
        pygame.image.load("C:/Users/Bobby/Downloads/icon.ico"), (32, 32))
